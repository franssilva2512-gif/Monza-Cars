...
export const BRANDS_DATA: BrandInfo[] = [
  { id: 'dodge', name: 'Dodge', country: 'EE.UU.', availableCount: 1, popularModel: 'Challenger Hellcat SRT', accentColor: '#D52B1E' },
  ...
  { id: 'volkswagen', name: 'Volkswagen', country: 'Alemania', availableCount: 0, popularModel: 'Sin stock actual', accentColor: '#001E50' },
