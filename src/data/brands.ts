...
export const BRANDS_DATA: BrandInfo[] = [
  ...
  { id: 'audi', name: 'Audi', country: 'Alemania', availableCount: 1, popularModel: 'A3 TFSI S-Tronic', accentColor: '#BB0A30' },
  { id: 'peugeot', name: 'Peugeot', country: 'Francia', availableCount: 1, popularModel: '208 Feline', accentColor: '#242424' },
  ...
  { id: 'ford', name: 'Ford', country: 'EE.UU.', availableCount: 0, popularModel: 'Sin stock actual', accentColor: '#102B4E' },
